...
rgb color_default[2] = {
	{.as_rgba = {0xAA, 0xAA, 0xAA, 0x0}},
	{.as_u32 = 0}
	};
rgb color_default_invert[2] = {{.as_u32 = 0}, {.as_rgba = {0xAA, 0xAA, 0xAA, 0xAA}}};
...
rgb color_to_rgb[16]={
		{.as_u32 = 0}, 
		{.as_rgba = {0, 0, 0xAA, 0x0}},
		{.as_rgba = {0, 0xAA, 0, 0x0}},
		{.as_rgba = {0, 0xAA, 0xAA, 0x0}},
		{.as_rgba = {0xAA, 0, 0, 0x0}},
		{.as_rgba = {0xAA, 0, 0xAA, 0x0}},
		{.as_rgba = {0xAA, 0x55, 0, 0x0}},
		{.as_rgba = {0xAA, 0xAA, 0xAA, 0x0}},
		{.as_rgba = {0x55, 0x55, 0x55, 0x0}},
		{.as_rgba = {0x55, 0x55, 0xFF, 0x0}},
		{.as_rgba = {0x55, 0xFF, 0x55, 0x0}},
		{.as_rgba = {0x55, 0xFF, 0xFF, 0x0}},
		{.as_rgba = {0xFF, 0x55, 0x55, 0x0}},
		{.as_rgba = {0xFF, 0x55, 0xFF, 0x0}},
		{.as_rgba = {0xFF, 0xFF, 0x55, 0x0}},
		{.as_rgba = {0xFF, 0xFF, 0xFF, 0x0}}
};
